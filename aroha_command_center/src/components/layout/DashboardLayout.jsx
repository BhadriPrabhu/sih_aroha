                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            <button 
                                ...
                                className={`relative p-1.5 rounded-md border shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-1 ${
                                    isNotifOpen ? 'bg-slate-100 border-slate-300 text-slate-900' : 'bg-white border-slate-200 text-slate-500 hover:text-slate-800'
                                }`}
                            >
                                <Bell size={18} />
                            ...
                            {isNotifOpen && (
                                <div className="absolute right-0 mt-2 w-80 bg-white border border-slate-200 rounded-md shadow-lg py-2 z-50">
                                    <div className="px-4 pb-2 border-b border-slate-100 flex justify-between items-center">
                                        ...
                                        <button className="text-[10px] font-bold text-sky-600 uppercase hover:text-sky-700">Clear All</button>
                                    </div>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`group flex items-center gap-2 pl-1.5 pr-3 py-1 rounded-md shadow-sm border transition-all focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-1 ${
                                    isProfileOpen ? 'bg-slate-50 border-slate-300' : 'bg-white border-slate-200 hover:bg-slate-50'
                                }`}
                            >
                            ...
                            {isProfileOpen && (
                                <div className="absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-md shadow-lg py-1 z-50">
                                    ...
                                    <div className="border-t border-slate-100 mt-1 pt-1">
                                        <button className="w-full text-left px-4 py-2 text-xs font-bold text-rose-600 hover:bg-rose-50 flex items-center gap-2 transition-colors">
...
function NavItem({ to, icon, label, exact, alert }) {
    return (
        <NavLink
            ...
            className={({ isActive }) => `flex items-center justify-between px-5 py-2.5 text-sm font-medium transition-colors border-l-2 ${
                isActive
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    <div className="flex justify-between items-center gap-4">
                        ...
                        <span className="text-[9px] font-medium text-slate-400 uppercase">{time}</span>
                    </div>
