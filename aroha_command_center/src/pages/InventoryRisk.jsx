      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex justify-between items-end mb-6">
          ...
          <div className="flex gap-3">
             <button className="bg-white border border-slate-200 text-slate-700 px-4 py-2 rounded-md text-sm font-semibold shadow-sm hover:bg-slate-50 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-200">
              Export Risk Report
            </button>
            <button className="bg-sky-600 text-white px-4 py-2 rounded-md text-sm font-semibold shadow-sm hover:bg-sky-700 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
              Add Manual Stock
            </button>
          </div>
        </div>
