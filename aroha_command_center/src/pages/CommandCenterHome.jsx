      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
          ...
          <div className="col-span-1 lg:col-span-5 bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-slate-200 flex flex-col">
            <div className="flex flex-wrap justify-between items-start gap-4 mb-6 border-b border-slate-100 pb-4">
              <div>
                <h3 className="text-base sm:text-lg font-bold text-slate-900">Criticality Trajectory</h3>
                <div className="flex items-center text-xl sm:text-2xl font-bold text-slate-900 tracking-tight mt-1">
                  <span>0.94</span>
                  <span className="whitespace-nowrap text-[10px] font-bold text-rose-700 ml-2 bg-rose-50 border border-rose-200 px-2 py-0.5 rounded tracking-wider">
                    High Risk
                  </span>
                </div>
              </div>
              <select className="shrink-0 w-full sm:w-auto text-xs font-medium bg-slate-50 border border-slate-200 rounded-md px-3 py-1.5 text-slate-700 outline-none focus:ring-1 focus:ring-sky-500">
